...
function searchLocation() {
  ...
  if (matchingStations.length === 0) {
    resultsDiv.innerHTML = `<strong>❌ No locations found for "${searchInput}"</strong><br>
  ...
  const nearestMarkerObj = markers.find(
